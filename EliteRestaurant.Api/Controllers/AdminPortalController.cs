...
public sealed class AdminPortalController(AppDbContext db, IWebHostEnvironment environment) : ControllerBase
{
    [HttpGet("config")]
    ...
    public ActionResult<AdminPortalConfigDto> GetConfig()
    {
        ...
        return Ok(new AdminPortalConfigDto(restaurantName, logoUrl, signInHint));
    }
